...
// Added by Kurt
// DLH: Selects Block Updates and the range selection/nominal readings of zAxis at approx 1g (flat, non-moving).
// 0x80 = 2g/bdu z/1g = 1027-1044
// 0x90 = 4g/bdu z/1g = 511-525
// 0xB0 = 8g/bdu z/1g = 251-268
#define ACCEL_2G 0x80
#define ACCEL_4G 0x90
#define ACCEL_8G 0xB0
...
class LSM303
{
  public:
    ...
    // sets bdu mode and accel sens only when _device is a LSM303DLH_DEVICE
    void setAccelSensitivity(int value);
